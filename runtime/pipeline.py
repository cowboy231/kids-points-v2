...
4. description 只留"核心事项名词" 2-6 字: 去主语(雯雯/孩子/宝贝)、形容词修饰(认真/连续/课外/三篇)、时间(7天/今天/第二天)。板子上只看"事项 + 分数",动作动词(买/写/判/补/读/找)保留。
...
输入:"今天雯雯做了认真大扫除，加20分"
输出:[{{"type":"income","amount":20,"description":"大扫除"}}]  # ← 去主语(雯雯)、形容词(认真)、时间(今天)
