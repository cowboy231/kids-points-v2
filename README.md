...
我女儿雯雯上小学二年级。每天放学回来，要完成语文抄写、数学口算、英语打卡……这些事情本身没什么问题，孩子也愿意做。

但问题在于：**日常该做的事做了不加分，超额的事做了也没有反馈。** 长此以往，孩子的"自驱力"慢慢会被"按部就班"磨掉。

所以我开始记录她的积分——不是为了奖惩，而是为了**让她看见自己的增量贡献**。
...
| 维度 | V1 | **V2** |
|------|----|--------|
| 记账方式 | 关键词匹配（规则写死） | **LLM 语义理解**（"今天数学加 1 分"也行，"雯雯今天表现很好"也行） |
...
python3 runtime/cli.py "雯雯今天数学加 1 分"
